...
<script type="text/javascript"
	src="${contextPath}/assets/js/js/jquery-1.9.1.min.js"></script>
	...
	<div class="vipBox">
		<div class="vipLeft">
			...
			<dl class="vipNav">
				...
				<dd>
					<a href="vipShoucang.jsp">收藏关注</a>
				</dd>
				<dt class="vip_2">账户设置</dt>
				<dd>
					<a href="${contextPath}/vipinfo">个人信息</a>
				</dd>
				<dd>
					<a href="${contextPath}/vipPwd">密码修改</a>
				</dd>
				<dd class="ddCur">
					<a href="${contextPath}/vipAddress">收货地址</a>
				</dd>
				<dd>
					<a href="vipXiaofei.jsp">消费记录</a>
				</dd>
				<dt class="vip_3">客户服务</dt>
				<dd>
					<a href="vipQuxiao.jsp">取消订单/退货</a>
				</dd>

				<dd>
					<a href="vipTousu.jsp">我的投诉</a>
				</dd>
			</dl>
			<!--vipNav/-->
		</div>
		...
		<div class="vipRight">
			<h2 class="vipTitle">修改收货地址</h2>
				<form action="${contextPath}/vipAddress/${address.id}/alter"
					method="post"   class="form-inline">
		    	<div class="form-group">
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"  /> 
						<br><br><br>
						选择地区:&emsp;<select name="zone">
						<option >请选择省</option>
					...
					<br><br><br>
					详细地址:&emsp;<input type="text" name="address" class="form-control"  value="${address.address }"/> 
						<br><br><br>
